...
public class MapBasic {
    ...
    public static void main(String[] args) {
        ...
        // 2. get() 메서드
        String capitalKR = capitalMap.get("대한민국"); // "서울"
        String capitalUS = capitalMap.get("미국"); // "워싱턴DC"
        String capitalCN = capitalMap.get("캐나다"); // null
        System.out.println("대한민국의 수도? " + capitalKR);
        System.out.println("미국의 수도? " + capitalUS);
        System.out.println("캐나다의 수도? " + capitalCN);

        // 3. getOrDefault() 메서드
        capitalCN = capitalMap.getOrDefault("캐나다", "N/A"); // "N/A"
        System.out.println("캐나다의 수도? " + capitalCN);

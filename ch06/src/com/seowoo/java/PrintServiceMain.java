...
class PrintServiceImplement implements PrintService {
...
public class PrintServiceMain {
    public static void main(String[] args) {
        ...
        // 3. 검색과 문서 출력
        PrintService printService = new PrintServiceImplement();
        boolean searched = printService.search(location);
        if(searched) {
            for(String file : documents) {
                printService.print(file);
            }
        }
    }
}
